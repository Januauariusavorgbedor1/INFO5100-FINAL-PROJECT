...
public class CustomerDAO {
    ...
    public CustomerDAO() {
      ...
      public String getNewCustomerId()throws  SQLException{

        
   ResultSet rs;
        try {
            rs = statement.executeQuery("Select max(customercode) from customers");

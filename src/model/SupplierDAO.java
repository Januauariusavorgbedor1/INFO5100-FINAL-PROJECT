...
public class SupplierDAO {
    ...
    public SupplierDAO() {
        try {
         ...
         public String getNewSupplierId()throws  SQLException{
  
   ResultSet rs;
        try {
            rs = statement.executeQuery("Select max(suppliercode) from suppliers");
